...
data modify entity @e[type=item,nbt={Item:{components:{"minecraft:custom_data":{replace:1b}}}},limit=1] Item set from entity @e[tag=af.selected_plant,distance=..10,limit=1] data."minecraft:custom_data".item
