...
execute as @e[tag=af.tool_rack_item_display,tag=af.selected_item_display,limit=1,distance=..10] at @s positioned ^ ^ ^0.25 run function af.base:furniture/remove/tool_rack_item
