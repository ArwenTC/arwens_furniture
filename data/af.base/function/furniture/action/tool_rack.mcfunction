...
execute if items entity @s weapon.* #af.base:tool_rack_item if entity @e[tag=af.selected_item_display,tag=!af.has_item,tag=!af.modified,distance=..10] run function af.base:furniture/action/tool_rack/not_has_item
