...
execute if block ~ ~ ~ #af.base:replaceable run setblock ~ ~ ~ light[level=15]
...
tag @e[tag=af.furniture_interaction,tag=af.new,type=interaction,distance=..10] add af.chandelier_interaction